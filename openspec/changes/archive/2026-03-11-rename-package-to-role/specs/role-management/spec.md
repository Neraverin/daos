...
### FROM: package-management TO: role-management
The capability has been renamed from "package" to "role" to better reflect its purpose in deployment orchestration contexts. All requirements remain functionally equivalent with updated terminology.
